...
**Output:**
```
The Process started through the PID: 12345
Enabled services and their respective ports:
Service         Port   Status
------------------------------
SSH             22     OPEN
HTTP            80     OPEN
...
**Output:**
```
Below are all the services available and capable of being configured.
Service         Port   Status
------------------------------
SSH             22     OPEN
HTTP            80     OPEN
...
Set a custom identifier for this honeypot instance.

**Syntax:**
```bash
deceptgold service --node_id <IDENTIFIER>
```

**Parameters:**
- `<IDENTIFIER>` - Custom name for this node

**Example:**
```bash
deceptgold service --node_id "production-honeypot-01"
```

**Notes:**
- Useful for managing multiple honeypot instances
- Default is system hostname
- Used in logs and telemetry
...
- [BLOCKCHAIN_INTEGRATION.md](BLOCKCHAIN_INTEGRATION.md) - Blockchain details
